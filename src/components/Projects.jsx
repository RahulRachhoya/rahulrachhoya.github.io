      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-gray-400 text-lg max-w-2xl mx-auto">
            Production-grade applications built with zero-cost infrastructure and rigorous engineering practices.
          </p>
        </div>
        ...
        <div className="text-center mt-12">
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="btn-outline inline-flex items-center gap-2 px-8 py-4 rounded-full text-white font-semibold"
          >
